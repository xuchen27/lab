...
int main(int argc, char ** argv)
{
    ...
    while(n.ok()&&('q' != waitKey(30)) )
    {
        ...
        //get gray image
        //cvtColor(rosImage,grayImage,CV_BGR2GRAY);
        ...
        dilate(thresholdImage, dilateImage, dilate_element);
        imshow("dilate",dilateImage);

        //Erode
        Mat Erode_element = getStructuringElement(MORPH_RECT, Size(11, 11));
        erode(dilateImage, erodeImage, Erode_element);
        ...
        //use internal class distance to recognize obstacles.
        if(cornersSize>0)
        {
